...
export const STRINGS = {
  ...
  'hero.eyebrow': { en: 'Engineering Manager · AI Builder', es: 'Engineering Manager · Constructor de IA' },
  'hero.title': {
    en: 'Engineering manager who still ships.',
    es: 'Engineering manager que sigue programando.',
  },
  'hero.lede': {
    en: 'I lead two squads at Ecologi (B Corp) and build agentic AI products in production. 11+ years in high-growth SaaS, from a platform service at King serving 200M+ users to a live AI running coach I designed, built and operate myself.',
    es: 'Lidero dos equipos en Ecologi (B Corp) y construyo productos de IA agéntica en producción. Más de 11 años en SaaS de alto crecimiento, desde un servicio de plataforma en King que servía a más de 200M de usuarios hasta un entrenador de running con IA que diseñé, construí y opero yo mismo.',
  },
  ...
  'ai.title': { en: 'Building — and trusting — AI in production', es: 'Construir (y confiar en) IA en producción' },
  'ai.p1': {
  ...
  'about.p2': {
    en: 'Running Coach started as a personal itch — I’m a runner, and I wanted a coach I could actually trust. It became the app I use myself and the clearest demonstration of how I think agentic AI should be built. When I’m not shipping, I’m usually on a trail somewhere.',
    es: 'Running Coach empezó como una necesidad personal: soy corredor y quería un entrenador en el que pudiera confiar de verdad. Se convirtió en la app que yo mismo uso y en la demostración más clara de cómo creo que debe construirse la IA agéntica. Cuando no estoy programando, suelo estar corriendo por algún sendero.',
  },
  ...
  'footer.built': {
    en: 'Built with React, TypeScript and Tailwind. Same design system as Running Coach.',
    es: 'Construido con React, TypeScript y Tailwind. El mismo sistema de diseño que Running Coach.',
  },
