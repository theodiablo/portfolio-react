...
import { Card, Col, Row, SSRProvider } from 'react-bootstrap'
              ...
              <div className="container h-100">
                <div className="row h-100 align-items-center justify-content-center text-center">
                  ...
                  <div className="col-lg-8 align-self-baseline">
                    ...
                    >
                      <Trans i18nKey="homePage.headerButton">
                        Find Out More
                      </Trans>
                    </Link>
                  </div>
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>
                          <Trans i18nKey="services2.body">
                            React, Vue, Web standards... This is a wider card
                      ...
                      >
                        <p>
                          <Trans i18nKey="about.description1">
                            ...
                            several companies{' '}
                            <i>
                              (Sopra Steria, Criteo, King - AKA Candy Crush)
                            </i>
                        ...
                        <p>
                          <Trans i18nKey="about.description2">
                            ...
                            , an e-commerce focused on reducing trash for
                            spanish households. In 3 years we planted 3500+
                            trees and avoided about 10 000 kg of plastic waste!
                          </Trans>
                        </p>
                        <p>
                          <Trans i18nKey="about.description3">
                            During all this time, I have acquired a wide range
                            of technical and business knowledge, which enables
                            me to work through many different business
                            situation.
                          </Trans>
                        </p>
                      </div>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-3 col-md-6 text-center">
                    <div className="mt-5">
                      ...
                      <p className="text-muted mb-0">
                        Is it really open source if it&apos;s not made with
                        love?
                      </p>
                    </div>
                  </div>
